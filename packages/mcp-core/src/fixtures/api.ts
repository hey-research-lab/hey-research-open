...
export const contract: HeyContract = {
  ...
  activity: { state: 'MEASURED', daysMeasured: 7, calls7d: 8_400, events7d: null, newestDay: '2026-09-24' },
...
export const projectContracts: HeyProjectContracts = {
  ...
  items: [
    { ...contract, role: 'token' },
    { ...contract, address: '0x3333000000000000000000000000000000000003', name: undefined, role: 'followup', watched: false, proxy: { state: 'NOT_READ', history: [] }, verifiedSource: { state: 'NOT_READ' }, interface: { state: 'NOT_READ', changes: [] }, activity: { state: 'NOT_READ', daysMeasured: 0, calls7d: null, events7d: null }, evidence: [] },
  ],
  total: 2,
  truncated: false,
