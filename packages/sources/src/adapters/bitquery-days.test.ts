...
import { ROBINHOOD_QUOTE_ASSETS, createBitqueryChainDaysAdapter, createBitqueryTradeDaysAdapter } from './bitquery-days';
...
describe('Bitquery trade days adapter', () => {
  ...
  it('folds side rows into one row per token and day, keeps the sell close, and drops a malformed day', async () => {
    ...
    expect(day).toMatchObject({ trades: 447, buys: 231, sells: 216, buyVolumeUsd: 18250.5, sellVolumeUsd: 17100.25, closeUsd: 0.0124, transfers: 1204 });
